const statistics = require('../models/statistics'), _ = require('lodash');

// ------------------ NETWORKS ------------------
exports.allProfiles = (req, res, next) => {
	statistics
		.networkAllProfiles(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
...
exports.allProjects = (req, res, next) => {
	statistics
		.networkAllProjects(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.networkProfiles = (req, res, next) => {
	statistics
		.networkProfiles(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.networkProfileSkills = (req, res, next) => {
	statistics
		.networkProfileSkills(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.networkLocation = (req, res, next) => {
	statistics
		.networkLocation(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.networkInterests = (req, res, next) => {
	statistics
		.networkInterests(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.networkProjects = (req, res, next) => {
	statistics
		.networkProjects(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.networkProjectAbout = (req, res, next) => {
	statistics
		.networkProjectAbout(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.networkProjectNeeds = (req, res, next) => {
	statistics
		.networkProjectNeeds(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.networkProjectFollow = (req, res, next) => {
	statistics
		.networkProjectFollow(req.params.name)
		.then(r => {
			if (typeof r === 'string') {
				return next([r, 'Unknown network']);
			} else {
...
exports.infoProfiles = (req, res, next) => {
	statistics
		.infoProfiles(req.params.profile_id)
		.then(r => {
			if (typeof r === 'string') {
