 ...
 */
exports.get = id => Array.isArray(id) ?
    redis
        .multi(id.map(i => ['zrank', keys.ranks, i]))
        .exec() :
    redis
        .zrank(keys.ranks, i);
...
exports.getPointHistory = (id, from, to = -1) => redis.zrange(keys.userRank(id), from, to === -1 ? Date.now() : to);